...
class UpdateSettingsControllerChild {
	...
	private function fill_course_data( Course $course, array $data ): Course {
		...
		$course->co_instructor_name  = $data['co_instructor_name'] ?? null;
		$course->course_date       = $data['course_date'] ?? null;
